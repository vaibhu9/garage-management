        ...
        <div class="col-12 col-md-9 col-lg-7 col-xl-8">
          <div class="card" style="border-radius: 15px;">
            <div class="card-body  p-5" style="border-radius: 15px;">
              <h2 class="text-uppercase text-center mb-5">Admin <span>Update</span></h2>
              <%
              ...
              <h3>Admin Id : <%=Ad_Id %></h3>

              <form name="frm" action="AdminUpdate" method="post" >
              
              <div data-mdb-input-init class="form-outline d-flex mb-4">
              <input type="hidden" name="adminId" value="<%=Ad_Id%>"/>
